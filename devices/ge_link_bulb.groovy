 ...
 *  Change 6:   2014-12-31 (mxrugg)
 *				Included Sticks18 code so the bulb will always dim when turned on/off over a period of 1.5 seconds
 */
metadata {
...
def on() {
	...
	// Standard On Operation
	//"st cmd 0x${device.deviceNetworkId} 1 6 1 {}"
    
	// Turns to the on state after 1.5 seconds
	"st cmd 0x${device.deviceNetworkId} 1 8 4 {fe 2500}"
}
...
def off() {
	...
	// Standard Off Operation
	//"st cmd 0x${device.deviceNetworkId} 1 6 0 {}"
    
	// Turns to the off state after 1.5 seconds
	"st cmd 0x${device.deviceNetworkId} 1 8 4 {00 2500}"
}
